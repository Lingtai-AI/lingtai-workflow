...
| lingtai-release-blog-publication | Publishing LingTai release blogs/logs after an authorized release; contributor audit and web publish path matter | Private/local artifacts, no publish authorization, or unsafe private contributor evidence | 2026-07-03 v0.16.1/v0.10.4 release correction: rejected issue/PR authors count; GitHub push auto-deploys lingtai-web | Jason H / lingtaidev3bot | 2026-07-03 | [`workflows/lingtai-release-blog-publication/`](workflows/lingtai-release-blog-publication/SKILL.md) |
