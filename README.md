...
| roundtable-expert-panel | A plan, PR, release gate, research brief, or product decision needs temporary expert perspectives and structured disagreement around one executor-owned task | A short deterministic action; no real reachable LingTai agents; or using panel consensus as authorization for side effects | Public companion project `rawpaper123/Roundtable-skill`, shared in Lingtai-AI/lingtai#531; reference/adaptation only, not a benchmark claim | rawpaper123 / Roundtable Skill | 2026-07-04 | [`workflows/roundtable-expert-panel/`](workflows/roundtable-expert-panel/SKILL.md) |
...
| community-issue-decision-pr | A repo has a batch of community-reported issues and each needs a taste decision plus Codex/GLM/Kimi review, then an unmerged PR for good ones or an ask-first comment/escalation for the rest | You lack authorization to open PRs/comment; the human asked you to merge/close/deploy; or reviewer bodies (Claude/Codex/GLM/Kimi) can't meet the review contract | Jason H's community-issue handling contract paired with the `lingtai-taste` skill and the review-slot pattern from `multi-model-daemon-orchestration`; no auto-merge, no auto-close | Claude Code (main writer), from Jason H contract | 2026-07-06 | [`workflows/community-issue-decision-pr/`](workflows/community-issue-decision-pr/SKILL.md) |
